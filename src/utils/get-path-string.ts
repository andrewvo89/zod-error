import { getBreadcrumbs, getObjectNotation, getZodPathArray } from '.';

import { ErrorMessageOptions } from '../types';
import { z } from 'zod';

export function getPathString(path: z.core.$ZodIssue['path'], options?: ErrorMessageOptions['path']): string {
